...
urlpatterns = patterns('',
    ...
    url(r'^(?P<device>[0-9A-Za-z]+)/coffeesuserchart/(?P<ndays>\d+)$', 'ecoaware.devices.views.coffeesuserchart', name='coffeesuserchart'),
    url(r'^(?P<device>[0-9A-Za-z]+)/energychart/(?P<ndays>\d+)$', 'ecoaware.devices.views.energychart', name='energychart'),
    url(r'^(?P<device>[0-9A-Za-z]+)/coffeecostchart/(?P<ndays>\d+)$', 'ecoaware.devices.views.coffeecostchart', name='coffeecostchart'),
    url(r'^(?P<device>[0-9A-Za-z]+)/energygroupandpersonalchart/(?P<ndays>\d+)$', 'ecoaware.devices.views.energygroupandpersonalchart', name='energygroupandpersonalchart'),
    url(r'^(?P<device>[0-9A-Za-z]+)/accenergygroupandpersonalchart/(?P<ndays>\d+)$', 'ecoaware.devices.views.accenergygroupandpersonalchart', name='accenergygroupandpersonalchart'),
